            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Nombre o Razón Social') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="nif_cif" class="col-md-4 col-form-label text-md-end">{{ __('NIF/CIF') }}</label>

                            <div class="col-md-6">
                                <input id="nif_cif" type="text" class="form-control @error('nif_cif') is-invalid @enderror" name="nif_cif" value="{{ old('nif_cif') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="localidad" type="text" class="form-control @error('localidad') is-invalid @enderror" name="localidad" value="{{ old('localidad') }}" required>
